...
class EmbedBuilder:
    ...
    def __init__(
        self,
        *,
        primary: Union[Colour, int, str] = "#7828C8",
        primary_light: Union[Colour, int, str] = "#AE7EDE",
        secondary: Union[Colour, int, str] = "#FF4ECD",
        secondary_light: Union[Colour, int, str] = "#FF95E1",
